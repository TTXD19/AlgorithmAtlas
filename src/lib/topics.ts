...
export const TOPICS: Topic[] = [
  ...
  /* ======================= 第二部分：演算法 ======================= */
  {
    ...
    subs: [
      { id: "bubble", name: "Bubble Sort", zh: "氣泡排序", desc: "相鄰交換，最直覺但最慢", apply: "教學用，理解「相鄰交換」與穩定性", time: "O(n²)", space: "O(1)", lvl: 1, state: "draft" },
      { id: "selection", name: "Selection Sort", zh: "選擇排序", desc: "每輪選最小的放到前面", apply: "交換次數最少，寫入昂貴的場合", time: "O(n²)", space: "O(1)", lvl: 1, state: "draft" },
      ...
      { id: "merge", name: "Merge Sort", zh: "合併排序", desc: "切半、各自排、合併，穩定", apply: "外部排序大檔案、鏈結串列排序、逆序對", time: "O(n log n)", space: "O(n)", lvl: 2, state: "draft" },
      ...
      { id: "heap-sort", name: "Heap Sort", zh: "堆積排序", desc: "先 heapify 再逐個取出，原地", apply: "記憶體受限又要保證 n log n 的場合", time: "O(n log n)", space: "O(1)", lvl: 2, state: "draft" },
      ...
      { id: "lower-bound", name: "Sorting Lower Bound", zh: "比較排序下界", desc: "用決策樹證明比較排序至少 Ω(n log n)", apply: "知道什麼時候不可能更快", time: "Ω(n log n)", space: "—", lvl: 3, state: "draft" },
    ],
  },
  {
    id: "searching",
    ...
    subs: [
      { id: "linear", name: "Linear Search", zh: "線性搜尋", desc: "一個一個看，無序資料唯一的選擇", apply: "小資料、無序資料、只找一次", time: "O(n)", space: "O(1)", lvl: 1, state: "draft" },
      { id: "binary", name: "Binary Search", zh: "二分搜尋", desc: "lower bound / upper bound 的邊界寫法", apply: "git bisect、字典查詢、版本相容性測試", time: "O(log n)", space: "O(1)", lvl: 1, state: "draft" },
      { id: "binary-answer", name: "Binary Search on Answer", zh: "二分答案", desc: "答案有單調性就能二分，配合可行性檢查", apply: "分配問題、最小化最大值", time: "O(n log R)", space: "O(1)", lvl: 3, state: "draft" },
      { id: "two-pointers", name: "Two Pointers", zh: "雙指標", desc: "對撞指標與同向指標", apply: "有序陣列配對、去重、回文判斷", time: "O(n)", space: "O(1)", lvl: 2, state: "draft" },
      { id: "sliding", name: "Sliding Window", zh: "滑動視窗", desc: "固定長度與可變長度兩種", apply: "串流統計、限流（rate limit）、最長不重複子字串", time: "O(n)", space: "O(k)", lvl: 2, state: "draft" },
    ],
  },
  {
    id: "backtracking",
    ...
    subs: [
      { id: "subsets", name: "Subsets", zh: "子集", desc: "每個元素選或不選，2ⁿ 種", apply: "功能開關組合測試、冪集列舉", time: "O(2ⁿ·n)", space: "O(n)", lvl: 2, state: "draft" },
  ...
  },
  {
    ...
    subs: [
      ...
      { id: "grid", name: "Grid as Graph", zh: "網格圖", desc: "把二維陣列當圖，四方向就是邊", apply: "數島嶼、迷宮、影像連通區域", time: "O(mn)", space: "O(mn)", lvl: 1, state: "draft" },
      { id: "cycle", name: "Cycle Detection", zh: "環偵測", desc: "有向圖用三色標記，無向圖用併查集", apply: "循環依賴、死鎖偵測", time: "O(V+E)", space: "O(V)", lvl: 2, state: "draft" },
      { id: "topo", name: "Topological Sort", zh: "拓撲排序", desc: "Kahn 的入度法與 DFS 完成順序法", apply: "套件安裝順序、課程先修、建置流程", time: "O(V+E)", space: "O(V)", lvl: 2, state: "draft" },
      { id: "bipartite", name: "Bipartite Check", zh: "二分圖判定", desc: "兩色染色，相鄰不同色", apply: "配對問題、衝突分組", time: "O(V+E)", space: "O(V)", lvl: 2, state: "draft" },
      { id: "dijkstra", name: "Dijkstra", zh: "單源最短路徑", desc: "非負權重圖上，用優先佇列逐步確定最短距離", apply: "導航最快路線、網路路由", time: "O((V+E) log V)", space: "O(V)", lvl: 2, state: "draft" },
      { id: "bellman-ford", name: "Bellman-Ford", zh: "含負權最短路徑", desc: "鬆弛 V−1 輪，第 V 輪還能鬆弛就有負環", apply: "匯率套利偵測、負權邊的路徑", time: "O(VE)", space: "O(V)", lvl: 3, state: "draft" },
  ...
  },
  {
    ...
    subs: [
      { id: "memo", name: "Memoization & Tabulation", zh: "記憶化與表格法", desc: "Fibonacci、Climbing Stairs，自頂向下與自底向上", apply: "任何有重疊子問題的遞迴，先加快取再說", time: "O(n)", space: "O(n)", lvl: 1, state: "draft" },
      { id: "dp-1d", name: "1-D DP", zh: "一維 DP", desc: "House Robber、Decode Ways，狀態只跟前幾項有關", apply: "序列決策、簡單的排程與計數", time: "O(n)", space: "O(1)", lvl: 2, state: "draft" },
      { id: "knapsack", name: "0/1 Knapsack", zh: "背包問題", desc: "每個物品選或不選，二維表與空間壓縮", apply: "預算分配、投資組合、貨櫃裝載", time: "O(nW)", space: "O(W)", lvl: 2, state: "draft" },
      { id: "unbounded", name: "Unbounded Knapsack", zh: "完全背包", desc: "物品可重複選，Coin Change 的 DP 版", apply: "找零最少硬幣數、無限供應的採購", time: "O(nW)", space: "O(W)", lvl: 2, state: "draft" },
      { id: "lis", name: "LIS", zh: "最長遞增子序列", desc: "O(n²) 的 DP 與 O(n log n) 的耐心排序", apply: "股價趨勢分析、俄羅斯套娃信封問題", time: "O(n log n)", space: "O(n)", lvl: 3, state: "draft" },
      { id: "lcs", name: "LCS", zh: "最長共同子序列", desc: "二維表，相等就對角線加一", apply: "diff 工具、DNA 序列比對、抄襲比對", time: "O(mn)", space: "O(mn)", lvl: 2, state: "draft" },
      { id: "edit-distance", name: "Edit Distance", zh: "編輯距離", desc: "插入、刪除、取代三種操作的最小次數", apply: "拼字校正、模糊搜尋、語音辨識評分", time: "O(mn)", space: "O(mn)", lvl: 3, state: "draft" },
      { id: "grid-dp", name: "Grid DP", zh: "網格路徑", desc: "Unique Paths、Min Path Sum，只能往右或往下", apply: "機器人路徑計數、影像接縫裁切", time: "O(mn)", space: "O(n)", lvl: 2, state: "draft" },
      { id: "interval-dp", name: "Interval DP", zh: "區間 DP", desc: "Burst Balloons、矩陣鏈乘，枚舉分割點", apply: "最佳括號化、多邊形三角剖分", time: "O(n³)", space: "O(n²)", lvl: 3, state: "draft" },
      { id: "bitmask-dp", name: "Bitmask DP", zh: "位元遮罩 DP", desc: "用整數的位元表示集合狀態", apply: "TSP、小規模指派問題", time: "O(2ⁿ·n)", space: "O(2ⁿ)", lvl: 3, state: "draft" },
      { id: "tree-dp", name: "Tree DP", zh: "樹上 DP", desc: "後序走訪，由子樹答案組合父節點答案", apply: "樹的直徑、最大路徑和、樹上獨立集", time: "O(n)", space: "O(h)", lvl: 3, state: "draft" },
    ],
  },
  {
    id: "string",
    ...
    subs: [
      { id: "hashing", name: "String Hashing", zh: "字串雜湊", desc: "多項式雜湊、模數與碰撞", apply: "快速比較子字串是否相等", time: "O(n)", space: "O(n)", lvl: 2, state: "draft" },
      { id: "rabin-karp", name: "Rabin-Karp", zh: "滾動雜湊比對", desc: "視窗移動時 O(1) 更新雜湊", apply: "抄襲偵測、多模式比對", time: "O(n+m)", space: "O(1)", lvl: 2, state: "draft" },
      { id: "kmp", name: "KMP", zh: "前綴函數比對", desc: "失敗函數讓比對指標不回頭", apply: "文字搜尋、入侵偵測系統的特徵比對", time: "O(n+m)", space: "O(m)", lvl: 3, state: "draft" },
      { id: "z-algo", name: "Z-Algorithm", zh: "Z 函數", desc: "每個位置與整串的最長共同前綴", apply: "字串比對、週期偵測", time: "O(n+m)", space: "O(n)", lvl: 3, state: "draft" },
      { id: "manacher", name: "Manacher", zh: "最長回文", desc: "利用已知回文的對稱性省掉重複展開", apply: "DNA 回文片段、文字分析", time: "O(n)", space: "O(n)", lvl: 3, state: "draft" },
  ...
  },
  {
    ...
    subs: [
      ...
      { id: "counting-bits", name: "Counting Bits", zh: "位元計數", desc: "Brian Kernighan 的 n & (n−1)", apply: "漢明距離、population count", time: "O(n)", space: "O(1)", lvl: 2, state: "draft" },
  ...
  },
  {
    ...
    subs: [
      { id: "gcd", name: "GCD & LCM", zh: "最大公因數", desc: "歐幾里得輾轉相除與擴展歐幾里得", apply: "分數化簡、比例、週期同步", time: "O(log n)", space: "O(1)", lvl: 1, state: "draft" },
